...
const Dashboard = () => {
    ...
    const lectures = [
        {name: 'Course Logistics', youtubeLink: '', image:course2Img, pdfLink:'', number:'01'},
        {name: 'Introduction', youtubeLink: '', image:course2Img, pdfLink:'', number:'02'},
        {name: 'Language Modeling: Part 1', youtubeLink: 'https://youtu.be/GNsujvGUjK8?feature=shared', image:course2Img, pdfLink:'https://drive.google.com/file/d/17nqS364abEcCNAshF71NPXasnBEwaYIE/view?usp=sharing', number:'03'},
        {name: 'Language Modeling: Part 2', youtubeLink: 'https://youtu.be/DHP9vwGtGVw?feature=shared', image:course2Img, pdfLink:'https://drive.google.com/file/d/1AzNPfv_IBvgRsFNdsOv3Ay6ycrxk8X1l/view?usp=sharing', number:'04'},
    ]
