...
from extract_audio import extract_audio_pydub
from extract_audio_segs import extract_audio_segments
...
if __name__ == "__main__":
    ...
    output_dir_path = create_output_directory(video_path, output_dir, type_bg_sub)
    
    audio_path = extract_audio_pydub(video_path, output_dir)
    ...
    if type_bg_sub.lower() == "frame_diff":
        ...
        last_timestamp = capture_slides_bg_modeling(
            video_path,
            output_dir_path,
    ...
    extract_audio_segments(audio_path, output_dir, output_dir_path, last_timestamp)
